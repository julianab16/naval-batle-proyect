        ...
        for (int row = 0; row < rows; row++) {
            for (int col = 0; col < columns; col++) {
                ...
                if (row == 0 && col > 0) {
                    ...
                    label.setStyle("-fx-padding: 5px; -fx-font-size: 16 px; -fx-text-fill: black;");
                ...
                if (col == 0 && row > 0) {
                    ...
                    label.setStyle("-fx-padding: 5px; -fx-font-size: 16px; -fx-text-fill: black;");
                    GridPane.setHalignment(label, HPos.CENTER); // Alinear el texto al centro horizontalmente
                    gridPane.add(label, col, row); // Agregar el número a la celda
            ...
            for (int row = 0; row < rows; row++) {
                for (int col = 0; col < columns; col++) {
                    ...
                    if (row == 0 && col > 0) {
                        Label label = new Label(Integer.toString(col));
                        label.setStyle("-fx-padding: 5px; -fx-font-size: 16px; -fx-text-fill: black;"); // Fondo blanco y tamaño de letra 16px
                        GridPane.setHalignment(label, HPos.CENTER); // Alinear el texto al centro horizontalmente
